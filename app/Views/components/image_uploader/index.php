...
<div role="button" class="dropContainer d-flex justify-content-center align-items-center" style="height: 75%; width: 35%;">
    <div class="body d-flex flex-column justify-content-center align-items-center">
        ...
        <img id="certificateImage" src="<?php echo $haveImage ? "data:image/png;base64, ". $imagePath : '#' ?>" class="<?php echo $haveImage ? '' : 'd-none'?> img-fluid object-fit-contain ${3|rounded-top,rounded-right,rounded-bottom,rounded-left,rounded-circle,|} mb-3" alt="image">
