<?php 
    $haveImage = strlen($imagePath) > 0 ? true : false;
    // $haveImage = true;
?>
<div role="button" class="dropContainer d-flex justify-content-center align-items-center w-25 h-50 ms-3">
    <div class="body d-flex flex-column justify-content-center align-items-center">
        ...
        <img id="certificateImage" src="<?php echo $haveImage ? base_url('uploads/image.png') : '#' ?>" class="<?php echo $haveImage ? '' : 'd-none'?> img-fluid object-fit-contain ${3|rounded-top,rounded-right,rounded-bottom,rounded-left,rounded-circle,|} mb-3" alt="image">
        ...
        <input form="processImage" id="imageFile" name="imageFile" type="file">
    </div>
</div>
